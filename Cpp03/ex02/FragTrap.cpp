...
{
	std::cout << "FragTrap " << this->_name << " took " << amount << " damage. His hit points are now: ";
...
void FragTrap::beRepaired(unsigned int amount)
{
	...
	{
		this->_hitpoints += amount;
		std::cout << "FragTrap " << this->_name << " was repaired. He now has " << this->_hitpoints << " hitpoints left." << std::endl;
		this->_energypoints--;
		std::cout << "Energy left: " << this->_energypoints << std::endl;
	}
	else
