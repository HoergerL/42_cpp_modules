...
{
	std::cout << "ScavTrap " << this->name << " took " << amount << " damage. His hit points are now: ";
...
void ScavTrap::beRepaired(unsigned int amount)
{
	...
	{
		this->_hitpoints += amount;
		std::cout << "ScavTrap " << this->name << " was repaired. He now has " << this->_hitpoints << " hitpoints left." << std::endl;
		this->_energypoints--;
		std::cout << "Energy left: " << this->_energypoints << std::endl;
	}
	else
...
{
	std::cout << "ScavTrap " << this->name << " entered the gate keeper mode" << std::endl;
}